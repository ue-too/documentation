[@ue-too/being](../../modules.md) / [index](../index.md) / GuardFunction

# Type Alias: GuardFunction()\<Context\>

> **GuardFunction**\<`Context`\> = (`context`) => `boolean`

Defined in: [schema-factory.ts:61](https://github.com/ue-too/ue-too/blob/79a36cf61d861e6b4e3302e81111636c6082a3db/packages/being/src/schema-factory.ts#L61)
