...
# 型エイリアス: RotateToHandlerFunction()

> **RotateToHandlerFunction** = (`targetRotation`, `camera`, `config`) => `number`

定義: [packages/board/src/camera/camera-rig/rotation-handler.ts:186](https://github.com/ue-too/ue-too/blob/feb7c80222df5d3cd97bfa1933bafe3190c6e48d/packages/board/src/camera/camera-rig/rotation-handler.ts#L186)
