...
# 関数: createCameraMatrix()

> **createCameraMatrix**(`cameraPos`, `zoom`, `rotation`, `devicePixelRatio`, `canvasWidth`, `canvasHeight`): `object`

定義: [packages/board/src/camera/utils/matrix.ts:292](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/camera/utils/matrix.ts#L292)
