...
# 関数: convertFromCanvas2ViewPort()

> **convertFromCanvas2ViewPort**(`pointInCanvas`, `viewportOriginInCanvasSpace`, `viewportHasFlippedYAxis`): `Point`

定義: [packages/board/src/utils/coordinate-conversions/canvas-viewport.ts:41](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/utils/coordinate-conversions/canvas-viewport.ts#L41)
