[@ue-too/board](../../modules.md) / [index](../index.md) / convertFromWindow2ViewPortWithCanvasOperator

# 関数: convertFromWindow2ViewPortWithCanvasOperator()

> **convertFromWindow2ViewPortWithCanvasOperator**(`point`, `canvas`, `viewportOriginInCanvasSpace`, `viewportHasFlippedYAxis`): `Point`

定義: [packages/board/src/utils/coorindate-conversion.ts:106](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/utils/coorindate-conversion.ts#L106)
