[@ue-too/board](../../modules.md) / [index](../index.md) / zoomLevelBoundariesShouldUpdate

# 関数: zoomLevelBoundariesShouldUpdate()

> **zoomLevelBoundariesShouldUpdate**(`zoomLevelBoundaries`, `targetMinZoomLevel`): `targetMinZoomLevel is number`

定義: [packages/board/src/utils/zoomlevel-adjustment.ts:144](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/utils/zoomlevel-adjustment.ts#L144)
