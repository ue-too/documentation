[@ue-too/board](../../modules.md) / [index](../index.md) / minZoomLevelBaseOnDimensions

# 関数: minZoomLevelBaseOnDimensions()

> **minZoomLevelBaseOnDimensions**(`boundaries`, `canvasWidth`, `canvasHeight`, `cameraRotation`): `number` \| `undefined`

定義: [packages/board/src/utils/zoomlevel-adjustment.ts:57](https://github.com/ue-too/ue-too/blob/7d57cce875ed7b8a4f4ee4e325a18e34159928f6/packages/board/src/utils/zoomlevel-adjustment.ts#L57)
