...
# 関数: calculateOrderOfMagnitude()

> **calculateOrderOfMagnitude**(`value`): `number`

定義: [packages/board/src/utils/ruler.ts:37](https://github.com/ue-too/ue-too/blob/feb7c80222df5d3cd97bfa1933bafe3190c6e48d/packages/board/src/utils/ruler.ts#L37)
