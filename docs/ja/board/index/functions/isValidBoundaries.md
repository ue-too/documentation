...
# 関数: isValidBoundaries()

> **isValidBoundaries**(`boundaries`): `boolean`

定義: [packages/board/src/camera/utils/position.ts:151](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/camera/utils/position.ts#L151)
