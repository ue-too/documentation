...
- **[@ue-too/being](_media/being)**: State machine library for entity AI and behavior
- **[@ue-too/math](_media/math)**: Vector and transformation utilities for component data
- **[@ue-too/board](_media/board)**: Canvas rendering system that can integrate with ECS
