...
# 函式: createDefaultCameraRig()

> **createDefaultCameraRig**(`camera`): [`CameraRig`](../interfaces/CameraRig.md)

定義於: [packages/board/src/camera/camera-rig/camera-rig.ts:940](https://github.com/ue-too/ue-too/blob/79a36cf61d861e6b4e3302e81111636c6082a3db/packages/board/src/camera/camera-rig/camera-rig.ts#L940)
