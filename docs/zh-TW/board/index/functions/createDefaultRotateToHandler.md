[@ue-too/board](../../modules.md) / [index](../index.md) / createDefaultRotateToHandler

# 函式: createDefaultRotateToHandler()

> **createDefaultRotateToHandler**(): [`RotateToHandlerFunction`](../type-aliases/RotateToHandlerFunction.md)

定義於: [packages/board/src/camera/camera-rig/rotation-handler.ts:486](https://github.com/ue-too/ue-too/blob/68da915137a31a45d7ce8043b13275ff7283045d/packages/board/src/camera/camera-rig/rotation-handler.ts#L486)
