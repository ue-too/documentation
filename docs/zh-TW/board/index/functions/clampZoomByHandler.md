...
# 函式: clampZoomByHandler()

> **clampZoomByHandler**(`delta`, `camera`, `config`): `number`

定義於: [packages/board/src/camera/camera-rig/zoom-handler.ts:261](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/camera/camera-rig/zoom-handler.ts#L261)
