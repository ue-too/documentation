[@ue-too/board](../../modules.md) / [index](../index.md) / convertDeltaToComplyWithRestriction

# 函式: convertDeltaToComplyWithRestriction()

> **convertDeltaToComplyWithRestriction**(`delta`, `camera`, `config`): `Point`

定義於: [packages/board/src/camera/camera-rig/pan-handler.ts:632](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/camera/camera-rig/pan-handler.ts#L632)
