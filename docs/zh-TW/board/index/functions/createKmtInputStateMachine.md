[@ue-too/board](../../modules.md) / [index](../index.md) / createKmtInputStateMachine

# 函式: createKmtInputStateMachine()

> **createKmtInputStateMachine**(`context`): [`KmtInputStateMachine`](../type-aliases/KmtInputStateMachine.md)

定義於: [packages/board/src/input-interpretation/input-state-machine/kmt-input-state-machine.ts:733](https://github.com/ue-too/ue-too/blob/9b787448328cf446379b1ea4cc5f4c79149cbec8/packages/board/src/input-interpretation/input-state-machine/kmt-input-state-machine.ts#L733)
