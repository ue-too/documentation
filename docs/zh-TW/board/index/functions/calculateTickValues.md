...
# 函式: calculateTickValues()

> **calculateTickValues**(`minValue`, `maxValue`, `orderOfMagnitude?`): `object`

定義於: [packages/board/src/utils/drawing.ts:466](https://github.com/ue-too/ue-too/blob/feb7c80222df5d3cd97bfa1933bafe3190c6e48d/packages/board/src/utils/drawing.ts#L466)
