[@ue-too/board](../../modules.md) / [index](../index.md) / createDefaultZoomToOnlyHandler

# 函式: createDefaultZoomToOnlyHandler()

> **createDefaultZoomToOnlyHandler**(): [`ZoomToHandlerFunction`](../type-aliases/ZoomToHandlerFunction.md)

定義於: [packages/board/src/camera/camera-rig/zoom-handler.ts:422](https://github.com/ue-too/ue-too/blob/79a36cf61d861e6b4e3302e81111636c6082a3db/packages/board/src/camera/camera-rig/zoom-handler.ts#L422)
