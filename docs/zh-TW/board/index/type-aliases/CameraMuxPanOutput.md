...
# 型別別名: CameraMuxPanOutput

> **CameraMuxPanOutput** = \{ `allowPassThrough`: `true`; `delta`: `Point`; \} \| \{ `allowPassThrough`: `false`; \}

定義於: [packages/board/src/camera/camera-mux/interface.ts:30](https://github.com/ue-too/ue-too/blob/7d57cce875ed7b8a4f4ee4e325a18e34159928f6/packages/board/src/camera/camera-mux/interface.ts#L30)
